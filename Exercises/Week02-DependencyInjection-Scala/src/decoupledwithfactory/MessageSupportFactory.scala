...
class MessageSupportFactory private() {
  ...
  try {
    props.load(new FileInputStream("/Users/nathanhanak/GithubRepos/SDP_Portfolio_Nhanak/Exercises/Week02-DependencyInjection-Scala/src/decoupledwithfactory/bean.properties"))
